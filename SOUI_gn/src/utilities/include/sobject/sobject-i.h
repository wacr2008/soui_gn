...
#define SOUI_CLASS_NAME_DECL_EX(theclass, classname,clsType) \
public:                                                 \
	...
	\
	LPCWSTR GetObjectClass()  const   override  ;       \
	\
	int GetObjectType()  const     override   ;         \
	\
	BOOL IsClass(LPCWSTR lpszName) const    override ;  \
	


 
#define SOUI_CLASS_NAME_DECL(theclass, classname) \
	SOUI_CLASS_NAME_DECL_EX(theclass,classname,0)



#define SOUI_CLASS_NAME_EX(theclass, classname,clsType) \
    LPCWSTR theclass::GetClassName()                    \
    {                                                   \
        return classname;                               \
    }                                                   \
    \
	int theclass::GetClassType()                        \
    {                                                   \
        int ret = clsType;                              \
		if(ret == SOUI::Undef)                                \
    ...
    \
    LPCWSTR theclass::BaseClassName()                   \
	{                                                   \
		return __super::GetClassName();                 \
	}                                                   \
	\
	LPCWSTR theclass::GetObjectClass()  const         \
	{                                                   \
		return classname;                               \
	}                                                   \
	\
	int theclass::GetObjectType()  const        \
	{                                                   \
        int ret = clsType;                              \
		if(ret == SOUI::Undef)                          \
	...
	\
	BOOL theclass::IsClass(LPCWSTR lpszName) const    \
	{                                                   \
