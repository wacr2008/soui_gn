...
namespace SOUI
{
	...
	{
		SOUI_CLASS_NAME_DECL_EX(SInterpolatorBase,L"interpolator_base",Interpolator)
	};

	class SOUI_EXP SLinearInterpolator: public SInterpolatorBase
	{
		SOUI_CLASS_NAME_DECL(SLinearInterpolator,L"Linear")
	public:
	...
	{
		SOUI_CLASS_NAME_DECL(SAccelerateInterpolator,L"Accelerate")
	...
	public: float getInterpolation(float input) override;

	};

	class SOUI_EXP SDecelerateInterpolator: public SInterpolatorBase {
		SOUI_CLASS_NAME_DECL(SDecelerateInterpolator,L"Decelerate")
	...
	{
		SOUI_CLASS_NAME_DECL(SAccelerateDecelerateInterpolator,L"AccelerateDecelerate")
	public:
		float getInterpolation(float input) override;
	};

	class SOUI_EXP SAnticipateInterpolator: public SInterpolatorBase {
		SOUI_CLASS_NAME_DECL(SAnticipateInterpolator,L"Anticipate")
	...
	public: float getInterpolation(float t) override;
	...
	class SOUI_EXP SAnticipateOvershootInterpolator : public SInterpolatorBase{
		SOUI_CLASS_NAME_DECL(SAnticipateOvershootInterpolator,L"AnticipateOvershoot")
	private: float mTension;
	...
	class SOUI_EXP SBounceInterpolator : public SInterpolatorBase{
		SOUI_CLASS_NAME_DECL(SBounceInterpolator,L"Bounce")
	...
	class SOUI_EXP SCycleInterpolator : public SInterpolatorBase{
		SOUI_CLASS_NAME_DECL(SCycleInterpolator,L"Cycle")
	...
	class SOUI_EXP SOvershootInterpolator: public SInterpolatorBase{
		SOUI_CLASS_NAME_DECL(SOvershootInterpolator,L"Overshoot")
