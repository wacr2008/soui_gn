...
#define SOUI_MSG_MAP_DECL()                                       \
protected:                                                          \
    BOOL ProcessSwndMessage(                              \
    UINT uMsg, WPARAM wParam,                        \
    LPARAM lParam, LRESULT& lResult)    override;                    

#define SOUI_MSG_MAP_DECL_EX()                                       \
protected:                                                          \
    virtual BOOL ProcessSwndMessage(                              \
    UINT uMsg, WPARAM wParam,                        \
    LPARAM lParam, LRESULT& lResult)    ;          

#define SOUI_MSG_MAP_BEGIN_TEMPLATE()                          \
    BOOL ProcessSwndMessage(                              \
    UINT uMsg, WPARAM wParam,                        \
    LPARAM lParam, LRESULT& lResult)                            \
    {
...
#define SOUI_MSG_MAP_BEGIN(theclass)                          \
    BOOL theclass::ProcessSwndMessage(                              \
    UINT uMsg, WPARAM wParam,                        \
    LPARAM lParam, LRESULT& lResult)                            \
    {
