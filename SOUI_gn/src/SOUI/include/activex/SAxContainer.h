                                    ...
                                    public IAdviseSink
{
    ...
    HRESULT InitControl(IStream* pStream = NULL)
    {
		...
		SComQIPtr<IPersistStreamInit> spPSI;
		hr = m_spControl->QueryInterface(__uuidof(IPersistStreamInit), (void**)&spPSI);

        if (SUCCEEDED(hr) && spPSI != NULL )
        {
            if ( pStream != NULL )
    ...
    HRESULT DoInplaceActivate()
    {
		...
		SComQIPtr<IAdviseSink> advise_sink ;
		 
		hr =  m_spControl->QueryInterface(__uuidof(IAdviseSink), (void**)&advise_sink);
                                             ...
                                             public ActiveXSite<SAxContainer>
{
    ...
    STDMETHOD(MonikerBindToStorage)(IMoniker *pMk, IBindCtx *pBC,
                                    IBindStatusCallback *pBSC, REFIID riid, void **ppvObj) override;
