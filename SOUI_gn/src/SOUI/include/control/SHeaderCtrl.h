...
namespace SOUI
{
   ...
   * Describe   列表头项
   */
  typedef struct SOUI_EXP SHDITEM {
	SHDITEM();
  ...
  {
      SOUI_CLASS_NAME_DECL(SHeaderCtrl, L"header")
  ...
  protected:
      ...
      {
          return dwHitTest!=(DWORD)-1 && LOWORD(dwHitTest)==HIWORD(dwHitTest);
      }
