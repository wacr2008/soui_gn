...
#define Y_IMIDFLAG (-1000)
	...
	SOUI_MSG_MAP_BEGIN(SMenuExItem)
    ...
    {
        SOUI_CLASS_NAME_DECL(SMenuExRoot,L"menuRoot")
	...
	{
        SOUI_CLASS_NAME_DECL(SMenuExSep,L"sep")
	public:
	...
	class SMenuExRunData : public TObjRefImpl<IObjRef>
	{
		friend class SMenuEx;
	public:
        SMenuExRunData(HWND hOwner,int nScale):m_bExit(FALSE),  m_nCmdID(-1), m_hOwner(hOwner), m_nScale(nScale)
		{
