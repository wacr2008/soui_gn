...
public:
	...
	TCHAR m_szFileName[80 * _MAX_PATH];     // contains full path name after return
		...
		HWND hWndParent = NULL)
	{
		...
		m_ofn.Flags = dwFlags | OFN_EXPLORER | OFN_ENABLEHOOK | OFN_ENABLESIZING | OFN_NOCHANGEDIR | OFN_ALLOWMULTISELECT;
