...
#define EVT_STD_WINDOWS            (EVT_STDEXT_BEGIN+0)
    ...
    {
        SOUI_CLASS_NAME_DECL(EventStdWindows, L"on_mouse_event")
    public:
...
#define EVT_TABVIEW_SELCHANGED      (EVT_TABVIEW_BEGIN + 2)
    ...
    {
        SOUI_CLASS_NAME_DECL(EventTabViewNew, L"on_tabview_new")
    public:
    ...
    {
        SOUI_CLASS_NAME_DECL(EventTabViewClose, L"on_tabview_close")
    public:
    ...
    {
        SOUI_CLASS_NAME_DECL(EventTabviewSelChanged, L"on_tabview_sel_changed")
    public:
...
#define EVT_LIST_HOVER_CHANGED      (EVT_LIST_BEGIN+0)
    ...
    {
        SOUI_CLASS_NAME_DECL(EventListHoverChanged, L"on_list_hover_changed")
    public:
...
#define EVT_DD_ITEM_SELECTED        (EVT_DROPDOWN_BEGIN+0)
    ...
    {
        SOUI_CLASS_NAME_DECL(EventDropDownItemSelected, L"on_dropdown_item_selected")
    public:
...
#define EVT_WEBVIEW_NOTIFY          (EVT_CEFWEBVIEW_BEGIN+0)
    ...
    {
        SOUI_CLASS_NAME_DECL(EventWebViewNotify, L"on_webview_notify")
    public:
