...
#define _tomAllowOffClient  512  // Allow points outside of the client area.
    ...
    //////////////////////////////////////////////////////////////////////////
	SOUI_ATTRS_BEGIN(RichEditObj)
		ATTR_RECT(L"margin", _marginRect, FALSE)
		//ATTR_UINT(L"id", _objId, FALSE)
		if (0 == strAttribName.CompareNoCase(L"id"))
		{
			::StrToInt64ExW(strValue, STIF_SUPPORT_HEX, &_objId);
			hRet = S_FALSE;
		}
		else
    ...
    RichEditObj * RichEditObj::GetById(INT64 lId)
    {
        if (lId == _objId)
            return this;
        ...
        {
            RichEditObj * pObjMatched = p->GetById(lId);
            if (pObjMatched)
            {
                return pObjMatched;
            }
    ...
    //
    //------------------------------------------------------------------------------
	SOUI_ATTRS_BEGIN(RichEditBkElement)
...
#define _tomAllowOffClient  512  // Allow points outside of the client area.
    ...
    //////////////////////////////////////////////////////////////////////////
    // RichEditContent
	SOUI_ATTRS_BEGIN(RichEditContent)
