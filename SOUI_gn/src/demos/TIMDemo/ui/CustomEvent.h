...
namespace SOUI
{
	...
	{
		SOUI_CLASS_NAME_DECL_EX(EventGetUnreadMsg, L"on_event_gerunread", 0)
	public:
	...
	{
		SOUI_CLASS_NAME_DECL_EX(EventSendMsg, L"on_event_sendmsg", 0)
	public:
	...
	{
		SOUI_CLASS_NAME_DECL_EX(EventHttpUploadFile, L"on_event_httpuploadfile", 0)
	public:
	...
	{
		SOUI_CLASS_NAME_DECL_EX(EventHttpDownFile, L"on_event_httpdownfile", 0)
	public:
	...
	{
		SOUI_CLASS_NAME_DECL_EX(EventHttpUploadFile, L"on_event_saveapprover", 0)
	public:
