...
* @date       2015-04-23
*
* Describe     本源码来自NSIS源码，因为本次用的不是NSIS软件的unicode版本
*			   对原有代码进行适当的修改。
*/
...
#define EXDLL_INIT()           {  \
    ...
    typedef struct _stack_t {
        ...
        char text[1024]; // this should be the length of string_size
    } stack_t;
    ...
    //作废void NSISCALL pushstring(TCHAR *str);
    void NSISCALL pushstringA(const char* str);
