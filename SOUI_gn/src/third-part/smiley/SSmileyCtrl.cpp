...
public://ISoSmileyCtrl
    STDMETHOD(Insert2Richedit)(IRichEditOle * ole) override;
    STDMETHOD(SetSource)(ISmileySource * pSource) override;
    STDMETHOD(GetSource)(ISmileySource ** ppSource) override;
