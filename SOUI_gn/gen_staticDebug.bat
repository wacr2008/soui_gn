...
goto end
:devBuild
gn gen --ide=vs2015 out/Debug "--args=is_debug=true  enable_safeseh=true use_system_yasm=true is_official_build=false is_component_build=false target_os=\"win\" target_cpu=\"x86\""
:end
