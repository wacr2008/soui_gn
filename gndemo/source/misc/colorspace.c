 ...
 *
 * $Id: colorspace.c 1985 2011-05-18 09:02:35Z Isibaar $
 *
 ****************************************************************************/
...
*/
#define MK_RGB565_B(RGB)  ((((RGB) << 3) & 0xf8) | ((RGB) & 0x7))
#define MK_RGB565_G(RGB)  ((((RGB) >> 3) & 0xfc) | (((RGB) >> 5) & 0x3))
#define MK_RGB565_R(RGB)  ((((RGB) >> 8) & 0xf8) | (((RGB) >> 11) & 0x7))
//end
